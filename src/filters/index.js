...
let loadDictCache ={};
let learnProgress={};
if(localStorage("loadOrgCache")){
    orgMap = localStorage("loadOrgCache").orgMap;
}
if(localStorage("loadDictCache")){
    loadDictCache = localStorage("loadDictCache");
}
if(localStorage("loadDictCache")){
    learnProgress = localStorage("loadDictCache").learn_driver_progress;
}
