...
//get Number
export function getTeachingCarNum(params){
    return fetch({
        method: 'GET',
        url: home.getTeachingCarNum,
        data: params
    })
}
export function getCountCoach(params){
    return fetch({
        method: 'GET',
        url: home.getCountCoach,
        data: params
    })
}
export function getCountTraining(params){
    return fetch({
        method: 'GET',
        url: home.getCountTraining,
        data: params
    })
}
